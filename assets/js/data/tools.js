NAV_DATA.categories.push({
  id: "tools", name: "实用工具", icon: "", links: [
    ...
    { title: "优品PPT", url: "https://www.ypppt.com/", desc: "免费 PPT 模板下载｜海量高质量模板", icon: "" },
    ...
    { title: "Wormhole", url: "https://wormhole.app/", desc: "点对点加密文件分享｜无需注册", icon: "" },
    { title: "图片在线处理", url: "https://imagestool.com/zh_CN/", desc: "免费在线图片处理｜无需上传文件", icon: "" },
    { title: "Device Shots", url: "https://deviceshots.com/", desc: "带壳截图生成器｜App 展示/自媒体", icon: "" },
    { title: "AHA Music", url: "https://aha-music.com/", desc: "在线听歌识曲｜浏览器内识别歌曲", icon: "" },
